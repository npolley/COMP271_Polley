...
//  inClass_11
//
//  Created by Nathaniel Polley on 4/12/16.
...
int main()
{
    ...
    cout<<"Test 1a: sequece is properly in place ~ expected yield 1 -> "<< b->is_word_in_tree("rrrrrrrrr")<<endl;
    cout<<"Test 1b: sequece is improper input ~ expected yield 0 -> "<< b->is_word_in_tree("srrrrrrrrr")<<endl;
    cout<<"Test 1c: input sequece is too large ~ expected yield 0 -> "<< b->is_word_in_tree("rrrrrrrrrrr")<<endl;
    ...
    cout<<"Test 2a: sequece is found in tree ~ expected yield 1 -> "<< b->is_word_in_tree("rrrrrrrrrr")<<endl;
    cout<<"Test 2b: sequece is improper input ~ expected yield 0 -> "<< b->is_word_in_tree("srrrrrrrrr")<<endl;
    cout<<"Test 2c: tested sequece is too large ~ expected yield 0 -> "<< b->is_word_in_tree("yyyyyyyyyyy")<<endl;
